...
class LightSensor {
    public:
        ...
        double ls_calspe[LS_NUM];
        bool broke;
        void test();
        int clusterNum;
    private:
        bool inCluster;
        uint8_t indexA[LS_NUM_IND] = {0, 1, 2, 3, 4, 5, 6, 7, 15, 14, 13, 12, 11, 10, 9, 8}; //MPOUT2
        uint8_t indexB[LS_NUM_IND] = {24, 25, 26, 27, 28, 29, 30, 31, 23, 22, 21, 20, 19, 18, 17, 16}; //MPOUT
